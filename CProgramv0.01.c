...
bool hello_world()
{
   ...
   printf("%s", str1); // %s is format specifier
...
//    hello_world();
    ...
    const int Log_table[16][16] = {{NULL ,0x00 , 0x19 , 0x01 , 0x32 , 0x02 , 0x1a , 0xc6 , 0x4b , 0xc7 , 0x1b , 0x68 , 0x33 , 0xee , 0xdf , 0x03},
    ...
    const int Antilog_table[16][16] = {{0x01 , 0x03 , 0x05 , 0x0f , 0x11 , 0x33 , 0x55 , 0xff , 0x1a , 0x2e , 0x72 , 0x96 , 0xa1 , 0xf8 , 0x13 , 0x35},
